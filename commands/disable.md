...
> "Runtime disabled for this project. Your edits will not trigger auto-commits or PRs. The Claude Code Action workflows in `.github/workflows/` are unaffected — they'll still review PRs you open manually. Re-enable with `/24hour-ClaudeCode:enable`."

Use this when:
- You're in a hot debugging session and don't want auto-commits noise
